...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li><a  href="staffroomchange.php"><i class="fa fa-qrcode fa-3x"></i> Student Change Room</a></li>
       ...
       <div class="row">
            ...
            <!-- Advanced Tables -->
            <?php
        $sql="SELECT s.name,t.user_id,t.room_id,t.conditions FROM student s INNER JOIN stud_trans t ON s.user_id=t.user_id WHERE t.conditions = 'ACTIVE'";
        ...
        $room=explode("-",$row["room_id"]);
            ?>
                 
            <tr class="odd gradeX">
                <td><a href="staffroomchange.php?idNum=<?=$row['IdNum'];?>"><?=$row["name"];?></a></td>
                <td><?=$row["user_id"]; ?></td>
                <td><?=$row["room_id"]; ?></td>
